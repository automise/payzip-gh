function scrollToAnchor(o){var i=$("a[name='"+o+"']");$("html,body").animate({scrollTop:i.offset().top-85},"slow")}$(document).ready(function(){$(window).scroll(function(){$(document).scrollTop()>50?$(".navbar-fixed-top").css("background-color","#c43234").css("height","50").css("padding-top",0):$(".navbar-fixed-top").css("background-color","transparent").css("height","auto").css("padding-top",25)}),$(window).width()>1650?$(".overlay").css("height",$(window).height()):$(window).width()>1250?$(".overlay").css("height","800"):$(window).width()>700?$(".overlay").css("height","600"):$(window).width()>500?$(".overlay").css("height","400"):$(".overlay").css("height","350"),$(window).resize(function(){$(window).width()>1650?$(".overlay").css("height",$(window).height()):$(window).width()>1250?$(".overlay").css("height","800"):$(window).width()>700?$(".overlay").css("height","600"):$(window).width()>500?$(".overlay").css("height","400"):$(".overlay").css("height","350")})});
